...
// ======================================================
// TEKS PANDUAN & OWNER (PENULISAN ULANG ANTI-ERROR)
// ======================================================
const PANDUAN_TEXT =
    '*❓ PANDUAN MEMBELI PRODUK DI NUSA KARSA*\n\n' +
...
async function connectToWhatsApp() {
    ...
    sock = makeWASocket({
        ...
        auth: state,
        browser: ['Nusa Karsa', 'Chrome', '3.4.0']
    });
    ...
    try {
        ...
        if (transactionStatus === 'settlement' || transactionStatus === 'capture') {
            ...
            if (deliveredItems.length === orderData.quantity) {
                ...
                await redis.set(orderId, JSON.stringify(orderData), { ex: 86400 });
